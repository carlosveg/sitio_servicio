...
export default function FreeCAD({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ol>
        <li>
          Visita el sitio web oficial de FreeCAD en tu navegador web preferido.
        </li>
        <li>
          Busca la sección de descargas y asegúrate de seleccionar la versión de
          FreeCAD compatible con tu sistema operativo (Windows 10 en este caso).
        </li>
        <li>
          Haz clic en el enlace de descarga correspondiente y guarda el archivo
          de instalación en una ubicación accesible en tu computadora.
        </li>
        <li>
          Una vez que la descarga se haya completado, navega hasta el directorio
          donde se guardó el archivo de instalación y haz doble clic en él para
          iniciar el proceso de instalación.
        </li>
        <li>
          Se abrirá el asistente de instalación de FreeCAD. Sigue las
          instrucciones proporcionadas en cada paso del asistente. Asegúrate de
          leer cuidadosamente las opciones disponibles y seleccionar las que
          mejor se ajusten a tus necesidades.
        </li>
        <li>
          Durante la instalación, es posible que se te solicite instalar
          complementos o bibliotecas adicionales para el correcto funcionamiento
          de FreeCAD. Asegúrate de seleccionar las opciones recomendadas por el
          instalador para garantizar una instalación completa y adecuada.
        </li>
        <li>
        ...
        <li>
          ...
          inicio o en tu escritorio. Haz clic en el acceso directo para iniciar
          FreeCAD.
        </li>
      </ol>
      <p>
        ¡Enhorabuena! Has instalado con éxito FreeCAD en tu sistema Windows 10.
        Ahora puedes explorar todas las funcionalidades de este software de
        modelado paramétrico en 3D y comenzar a crear tus propios diseños y
        modelos.
      </p>
      <p>
        Recuerda consultar la documentación oficial de FreeCAD y explorar los
        tutoriales disponibles para aprovechar al máximo las capacidades de este
        poderoso software de geometría computacional. ¡Disfruta de tu
      ...
      <div className='ejercicio_espiral ejercicio'>
        ...
        <p>
          ...
          <br />
          Descarga el archivo
          <a href={alambres_geo}>alambres.geo</a> y también descarga el archivo
        ...
        <div className='ejercicio_placas ejercicio'>
          ...
          <p>
            ...
            <h3>Parte GMSH</h3>
            <p>
              Ahora abriremos el archivo en GMSH y crearemos el archivo .geo con
              el video que se sugirió previamente en la parte de la construcción
              del objeto en FreeCAD. El archivo geo los descargarás
