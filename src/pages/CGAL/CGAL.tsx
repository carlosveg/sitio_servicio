  ...
  return (
    ...
    >
      ...
      <p>
        ...
        para una amplia variedad de problemas de geometría computacional. Desde
        operaciones básicas hasta algoritmos más complejos, CGAL ofrece una gran
        cantidad de funciones listas para usar que simplificarán las tareas de
        geometría computacional en el contexto de la física. Con CGAL, los
        usuarios podrán realizar cálculos precisos, realizar consultas
        geométricas y resolver problemas geométricos de manera eficiente.
      </p>
      ...
      <p>
        ...
        <ol>
          <li>
            Visita el sitio web oficial de CGAL (www.cgal.org) en tu navegador.
          </li>
          <li>
          ...
          <li>
            ...
            instalación o script de configuración. Lee cuidadosamente cada paso
            y elige las opciones que mejor se adapten a tus necesidades.
          </li>
          <li>
          ...
          <li>
            Una vez que la instalación se haya completado con éxito, verifica si
            CGAL está correctamente configurado en tu sistema. Puedes hacerlo
            abriendo una terminal o línea de comandos y ejecutando un ejemplo o
            probando algunos comandos básicos de CGAL.
          </li>
          <li>
            Si los pasos anteriores se han realizado correctamente y no se han
            producido errores, ¡enhorabuena! CGAL está instalado y listo para su
            uso en tu sistema.
          </li>
        </ol>
        Recuerda consultar la documentación oficial de CGAL para obtener más
        detalles sobre su uso y aprovechar al máximo sus capacidades. ¡Disfruta
        de la geometría computacional con CGAL y explora las diversas
        aplicaciones que ofrece este poderoso software!
        <br />
        <br />
      ...
      <ol>
        ...
        <li>
          Abre una terminal o línea de comandos y navega hasta el directorio del
          ejercicio.
        </li>
        <li>
          Crea un directorio de compilación dentro del directorio del ejercicio.
        ...
        <li>
          ...
          compilar el ejercicio ejecutando el siguiente comando en la terminal:
          <br />
        ...
        <li>
          ...
          en el archivo CMakeLists.txt. Por lo general, se usará un comando como
          este:
          <br />
          <code>./ejercicio</code>
          <br />
      ...
      <p>
        Siguiendo estos pasos, podrás compilar y ejecutar los ejercicios de CGAL
        utilizando CMake en Windows 10. Recuerda consultar la documentación del
        ejercicio y el archivo CMakeLists.txt para obtener instrucciones
        específicas adicionales si es necesario.
      </p>
      <p>
      ...
      <div className='ejercicios'>
        <div className='ejercicio'>
          ...
          <div className='descripcion_ejercicio'>
            <p>
              ...
              convexo más pequeño o el poliedro convexo más pequeño (dependiendo
              de la dimensión del espacio) que contiene todos los puntos del
              conjunto. <br />
              ...
              La envolvente convexa tiene aplicaciones en diversos campos, como
              la geometría computacional, la optimización, la investigación de
              operaciones y la visión por computadora. Se utiliza para resolver
              problemas relacionados con la convexidad, como la búsqueda de
              puntos extremos, la separación de conjuntos y el cálculo de
              intersecciones convexas, entre otros. <br />
            </p>
            <p>
        ...
        <div className='ejercicio1 ejercicio'>
          ...
          <p>
            ...
            praesentium velit exercitationem doloribus accusantium voluptas, qui
            dicta. Tenetur, sed accusamus! Sapiente consequuntur sit delectus
            labore, iste consectetur atque non impedit eveniet porro numquam
            aliquid, assumenda quidem temporibus? Voluptatem quae numquam hic
            tempore quos aut iusto est quasi? Similique, eligendi dolor! Ullam
            veniam magnam, quod officia quis voluptate esse dicta obcaecati,
            pariatur ex eaque eveniet accusantium aliquam facere delectus et,
            labore ratione suscipit aperiam sed. Est ratione dicta ullam itaque
            eum. Ipsam fuga, explicabo totam reiciendis dolore commodi dolorum
            ad neque consequuntur velit eius eum accusamus adipisci voluptatibus
            aliquam maiores eligendi harum ut quisquam iure doloremque suscipit
        ...
        <div className='ejercicio'>
          ...
          <p>
            Se muestra la construcción de 2 objetos en código con C++ usando la
            librería CGAL en el cual uno tendrá la forma de un córazon y el otro
            de un cráneo El código lo puedes descargar aquí{' '}
        ...
        <div className='ejercicio skull'>
          <h3>Cráneo</h3>
          <p className='text'>
            Este ejercicio tratará sobre una figura de un cráneo para hacerlo de
            forma sólida
          </p>
          <p>
