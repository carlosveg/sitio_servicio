    ...
    >
      ...
      <ol>
        ...
        <li>
          ...
          OneLab compatible con tu sistema operativo.
        </li>
        <li>
        ...
        <li>
          Al abrir OneLab por primera vez, es posible que se te solicite iniciar
          sesión con tu cuenta de usuario o crear una nueva cuenta. Sigue las
          instrucciones proporcionadas y completa el proceso de inicio de
          sesión.
        </li>
        <li>
          Una vez que hayas iniciado sesión, podrás comenzar a utilizar OneLab y
          acceder a todas sus funcionalidades y herramientas.
        </li>
        <li>
          ...
          preferencias, ajustes de notificación, fuentes de datos, y más, según
      ...
      <p>
        ...
        las características disponibles y descubre cómo OneLab puede ayudarte en
        tus tareas relacionadas con geometría computacional y física. ¡Disfruta
        de tu experiencia con OneLab!
      </p>
      ...
      <div className='ejercicios'>
        <div className='ejercicio ejercicio-alambre'>
          ...
          <p>
            Primero se muestra los archivos abiertos en gmsh antes de correr los
            archivos
        ...
        <div className='ejercicio ejercicio-placas'>
          ...
          <p>
            Se muestra la imagen al abrir los archivos creados y configurados en
            FreeCAD
